...
if ($_SESSION['rol']=='003'){
    ...
    ?>
<div class="container">
    <h4>Listado de pedido no facturadoss</h4> 
        <?php
...
$listaPedidos=$tPedido->getPedidosNoFacturadosCliente($idCliente);
$tablalp = LineasPedidos::singletonLineasPedidos();
//$pedido= $tablalp->getLineasUnPedido2('20190130013');
...
function pintarTuplaPedido($tuplaPedido){
    $cabeceraTabla= "<table class='highlight'>
    <tr>
        <td><form name=\"formulario\" method=\"post\" action=\"../PDF/imprimirPedidoPDF.php\">
